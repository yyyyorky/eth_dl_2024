...
state_dic = torch.load(os.path.join(C.data_dir, 'checkpoints', 'sequence_model_spatial.pth'), weights_only=True)
...
np.save(C.data_dir + 'result/prediction_temporal_spatial.npy', prediciton_record)
