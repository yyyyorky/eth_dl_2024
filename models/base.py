...
def make_edgesets_dict(n_coarse_levels = 1):
    pass
...
if __name__ == '__main__':
    ...
    edge_processor_dict = {'edge_processor': functools.partial(nn.Linear, 6, 6)}
    node_processor_dict = {'node_processor': functools.partial(nn.Linear, 6, 6)}

    block = BaseBlock(edge_processor_dict, node_processor_dict)
# %%
