...
state_dic = torch.load(os.path.join(C.data_dir, 'checkpoints', 'sequence_model_2mp.pth'), weights_only=True)
...
state_dic = torch.load(os.path.join(C.data_dir, 'checkpoints', 'autoencoder_2mp.pth'), weights_only=True)
